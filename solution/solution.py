...
def call_openai(
    ...
    return response_text, max(latency, 1e-9)
...
def format_comparison_table(results: list[dict]) -> str:
    ...
    """
    def truncate(value: Any, max_length: int = 40) -> str:
        text = str(value)
    ...
    for result in results:
        rows.append([
            ...
            f"${result.get('gpt4o_cost_estimate', 0):.6f}",
        ])
...
# The test loader names this module from the repo folder, which contains "-".
# Give unittest.mock.patch a valid Python module alias to target.
_TEST_MODULE_ALIAS = "day01_lab_assignment_solution"
...
for _fn in (
    ...
    _fn.__module__ = _TEST_MODULE_ALIAS
